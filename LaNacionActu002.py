...
url = 'https://www.lanacion.com.ar/politica/la-interna-cambiemos-ucr-nid2195443'
...
cast = soup.find_all(id="cuerpo")

for ca in cast:
    tx="".join(ca.text)
    Ca1 = int(tx.find('podcast'))
    print(Ca1, "Podcast")
    Ca2 = int(tx.find('los principales conceptos:'))
    print(Ca2, 'Principales concep')
print(popo)
if  (Ca1 != -1) or (Ca2 != -1) or popo == 1:
    Pod = "Podc "
    print("Es un podcast")
